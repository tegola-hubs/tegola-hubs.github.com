...
r = \ell\, \sin\left(\frac{\theta}{2}\right) 
  = 10\,\text{m} \times \sin\left(1.25^\circ\right) = 0.22\,\text{m}
\end{equation}
...
\begin{equation}
\label{eq:dens2power}
p = \frac{10^{\frac{1}{10}\beta}}{a}  = \frac{10 ^ {\frac{33}{10}\,\text{dBm}}}{0.15\,\text{m}^2} = 
...
\begin{equation}
\frac{10^{\frac{1}{10}\beta}}{0.15\,\text{m}^2} = 1.5\,\text{mW}/\text{m}^2
\end{equation}
...
$$
\begin{array}{rcl}
P_r &=& -6.5\,\text{dBm} + 23\,\text{dB} +
20\log\left(\frac{0.0125\,\text{m}}{4\pi \times
  13,000\,\text{m}}\right)\\
    &=& -6.5 + 23 - 142 = -125\,\text{dBm}\\
\end{array}
$$
...
$-95\,\text{dBm}$. At the legal limit we are $30\,\text{dB}$ or about
1000 times weaker than we need to be to sustain a link at the
advertised distance. Clearly transmitting at $33\, \text{dBm}$ with
our non-operational licence this is feasible, indeed we have $9\,\text{dB}$
...
\end{equation}
which works out to all of $5\,\text{m}$ at the regulatory limit and
